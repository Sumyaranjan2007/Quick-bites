...
const en: Dict = {
  ...
  "tracking.etaWaiting": "Waiting for the kitchen to accept your order",
...
const kn: Dict = {
  ...
  "tracking.etaWaiting": "ಅಡುಗೆಮನೆ ನಿಮ್ಮ ಆರ್ಡರ್ ಸ್ವೀಕರಿಸುವುದನ್ನು ಕಾಯಲಾಗುತ್ತಿದೆ",
...
const hi: Dict = {
  ...
  "tracking.etaWaiting": "रसोई के आपका ऑर्डर स्वीकार करने का इंतज़ार है",
